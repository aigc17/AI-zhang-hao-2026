...
function seedDatabase() {
  ...
  const psEmails = [
    'jijvyjle@pslrai.com', 'ufccavqn@pslrai.com', 'qpevcpfk@pslrai.com',
    'vbdyuxms@pslrai.com', 'sqmdohch@pslrai.com', 'tejekvhx@pslrai.com',
    'yerffihy@pslrai.com', 'aahahscj@pslrai.com', 'xjqjjlxr@pslrai.com',
    'wvdatyuy@pslrai.com',
  ];
